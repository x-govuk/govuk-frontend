...
We've introduced a new `inverse-text` functional colour to use on dark backgrounds that use [functional colours](https://design-system.service.gov.uk/styles/colour/#govuk-web-palette) such as `brand`, `success` and `error`.
